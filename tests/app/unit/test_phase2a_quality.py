...
from trading_advisor_3000.app.data_plane.canonical import run_data_quality_checks


def _bar(*, contract_id: str, ts_open: str, ts_close: str) -> CanonicalBar:
    return CanonicalBar(
...
def test_quality_detects_duplicates() -> None:
    rows = [
        _bar(contract_id="BR-6.26", ts_open="2026-03-16T10:00:00Z", ts_close="2026-03-16T10:15:00Z"),
        _bar(contract_id="BR-6.26", ts_open="2026-03-16T10:00:00Z", ts_close="2026-03-16T10:15:00Z"),
    ]
...
def test_quality_detects_whitelist_violations() -> None:
    rows = [_bar(contract_id="NQ-6.26", ts_open="2026-03-16T10:00:00Z", ts_close="2026-03-16T10:15:00Z")]
    errors = run_data_quality_checks(rows, whitelist_contracts={"BR-6.26"})
