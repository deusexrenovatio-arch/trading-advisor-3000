...
from trading_advisor_3000.app.runtime import RuntimeConfigurationError
...
def test_phase6_fastapi_smoke_boots_with_durable_runtime_profile(monkeypatch: pytest.MonkeyPatch) -> None:
...
def test_phase6_fastapi_boot_fails_closed_without_postgres_dsn_on_staging() -> None:
    app = create_app(
        env={
            "TA3000_RUNTIME_PROFILE": "staging",
            "TA3000_SIGNAL_STORE_BACKEND": "postgres",
