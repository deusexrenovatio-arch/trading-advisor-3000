...
PROOF_SCRIPT = ROOT / "scripts" / "run_phase2a_spark_proof.py"
...
def test_phase2a_spark_job_executes_and_matches_contract_outputs(tmp_path: Path) -> None:
...
def test_phase2a_spark_disprover_fails_when_runtime_bootstrap_is_broken(tmp_path: Path) -> None:
