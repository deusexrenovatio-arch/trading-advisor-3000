...
from trading_advisor_3000.app.contracts import DecisionCandidate, FeatureSnapshotRef, Mode, Timeframe, TradeSide
from trading_advisor_3000.app.interfaces.api import RuntimeAPI
from trading_advisor_3000.app.interfaces.asgi import create_app
from trading_advisor_3000.app.runtime import build_runtime_stack, read_runtime_bootstrap_config
from trading_advisor_3000.app.runtime.config import StrategyVersion
from trading_advisor_3000.app.runtime.ops import build_runtime_operational_snapshot
...
CHANGE_POLICY_PATH = ROOT / "docs" / "architecture" / "app" / "contract-change-policy.md"
...
def test_phase3_manifest_covers_release_blocking_boundaries_and_policy() -> None:
    ...
    assert change_policy_ref == "docs/architecture/app/contract-change-policy.md"
