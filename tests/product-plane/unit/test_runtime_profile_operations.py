...
def test_runtime_profile_profile_is_fail_closed_when_live_flags_are_not_explicitly_set() -> None:
    env = {
...
def test_runtime_profile_runtime_snapshot_is_not_ready_when_required_secrets_are_missing() -> None:
    env = {
        **_base_env(),
...
def test_runtime_profile_runtime_snapshot_and_metrics_are_ready_when_secrets_exist() -> None:
    env = {
        **_base_env(),
        "TA3000_STOCKSHARP_API_KEY": "stocksharp-secret-001",
        "TA3000_FINAM_API_TOKEN": "finam-token-001",
...
def test_runtime_profile_bridge_builder_respects_retry_policy_from_environment() -> None:
    env = {
        **_base_env(),
        "TA3000_STOCKSHARP_API_KEY": "stocksharp-secret-001",
        "TA3000_FINAM_API_TOKEN": "finam-token-001",
