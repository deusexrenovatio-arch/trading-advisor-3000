...
from trading_advisor_3000.product_plane.runtime.analytics import build_signal_outcomes, shadow_replay_outcome_store_contract


def test_shadow_replay_outcomes_contract_has_required_tables_and_columns() -> None:
    manifest = shadow_replay_outcome_store_contract()
