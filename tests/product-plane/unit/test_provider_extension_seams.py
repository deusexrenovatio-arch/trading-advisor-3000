...
from trading_advisor_3000.product_plane.data_plane import (
...
def test_provider_extension_seams_default_data_provider_registry_includes_market_fundamentals_news_paths() -> None:
...
def test_provider_extension_seams_data_provider_registry_rejects_duplicate_provider_id() -> None:
...
def test_provider_extension_seams_context_provider_registry_aggregates_fundamentals_and_news_slices() -> None:
