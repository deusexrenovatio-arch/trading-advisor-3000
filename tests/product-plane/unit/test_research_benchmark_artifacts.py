...
ARTIFACT_DIR = (
    ...
    / "artifacts"
    / "benchmarks"
    / "research-phase2b-benchmark-2026-04-14"
)


def test_committed_benchmark_artifacts_exist_and_record_threshold_pass() -> None:
    report_json = ARTIFACT_DIR / "phase2b-benchmark-report.json"
    report_md = ARTIFACT_DIR / "phase2b-benchmark-report.md"
    ...
    assert payload["artifacts"]["report_json"] == "phase2b-benchmark-report.json"
    assert payload["artifacts"]["report_md"] == "phase2b-benchmark-report.md"
