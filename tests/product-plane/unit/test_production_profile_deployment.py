...
def test_production_profile_production_like_profile_files_exist() -> None:
    expected = {
    ...
    for path in expected:
        assert path.exists(), f"missing operational-hardening production-like artifact: {path}"


def test_production_profile_compose_wires_runtime_sidecar_postgres_and_prometheus() -> None:
...
def test_production_profile_env_template_contains_required_placeholders() -> None:
...
def test_production_profile_prometheus_scrapes_runtime_operational_profile() -> None:
