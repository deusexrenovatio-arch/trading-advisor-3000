...
def test_review_metrics_strategy_and_instrument_dashboards_compute_r_metrics() -> None:
    outcomes = [
...
def test_review_observability_report_handles_empty_outcomes() -> None:
    report = build_review_observability_report(outcomes=[], signal_events=[])
...
def test_review_metrics_ignore_non_closed_or_invalid_closed_ts_outcomes() -> None:
    outcomes = [
