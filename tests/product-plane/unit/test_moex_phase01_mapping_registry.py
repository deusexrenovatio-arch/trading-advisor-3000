...
def test_mapping_registry_allows_soft_deactivated_history(tmp_path: Path) -> None:
    mapping_path = Path("configs/moex_phase01/instrument_mapping_registry.v1.yaml")
    universe_path = Path("configs/moex_phase01/universe/moex-futures-priority.v1.yaml")
