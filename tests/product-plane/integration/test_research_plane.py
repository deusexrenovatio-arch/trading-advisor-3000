...
def test_research_plane_backtest_is_reproducible_and_writes_outputs(tmp_path: Path) -> None:
...
def test_research_plane_backtest_supports_walk_forward_costs_and_strategy_metrics(tmp_path: Path) -> None:
    bars = _load_bars(SOURCE_FIXTURE)
