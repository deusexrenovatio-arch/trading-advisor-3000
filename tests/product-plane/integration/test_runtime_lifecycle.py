...
def test_runtime_lifecycle_runtime_replay_lifecycle_and_idempotent_publication() -> None:
...
def test_runtime_lifecycle_runtime_supports_cancel_and_removes_active_signal() -> None:
    stack = build_runtime_stack(telegram_channel="@ta3000_signals")
    stack.strategy_registry.register(
        StrategyVersion(
            strategy_version_id="ma-cross-v1",
