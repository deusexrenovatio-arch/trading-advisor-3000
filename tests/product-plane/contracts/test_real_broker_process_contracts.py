...
def test_real_broker_process_connector_profile_schema_and_fixture_match() -> None:
...
def test_real_broker_process_report_schema_and_fixture_match() -> None:
...
def test_real_broker_process_manifest_references_new_contracts() -> None:
...
def test_real_broker_process_contract_surfaces_include_connector_profile_and_report() -> None:
