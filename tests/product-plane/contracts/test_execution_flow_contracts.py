...
from trading_advisor_3000.product_plane.contracts import BrokerEvent, BrokerFill, BrokerOrder, RiskSnapshot
...
def test_execution_flow_schema_snapshots_exist() -> None:
    expected = {
