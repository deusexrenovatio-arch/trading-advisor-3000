...
def test_phase01_raw_ingest_report_status_semantics_are_unambiguous() -> None:
    ...
    pass_report = build_raw_ingest_run_report_v2(
        ...
        raw_table_path="artifacts/codex/moex-phase01/pass1/delta/raw_moex_history.delta",
        raw_ingest_progress_path="artifacts/codex/moex-phase01/pass1/raw-ingest-progress.jsonl",
        raw_ingest_error_path="artifacts/codex/moex-phase01/pass1/raw-ingest-errors.jsonl",
        raw_ingest_error_latest_path="artifacts/codex/moex-phase01/pass1/raw-ingest-error.latest.json",
    ...
    pass_noop_report = build_raw_ingest_run_report_v2(
        ...
        stale_rows=0,
        watermark_by_key={"BR-6.26|1m|BRM6": "2026-04-01T10:19:59Z"},
        raw_table_path="artifacts/codex/moex-phase01/pass2/delta/raw_moex_history.delta",
        raw_ingest_progress_path="artifacts/codex/moex-phase01/pass2/raw-ingest-progress.jsonl",
        raw_ingest_error_path="artifacts/codex/moex-phase01/pass2/raw-ingest-errors.jsonl",
        raw_ingest_error_latest_path="artifacts/codex/moex-phase01/pass2/raw-ingest-error.latest.json",
        changed_windows=[],
