...
def test_release_blocking_manifest_covers_release_blocking_boundaries_and_policy() -> None:
...
def test_release_blocking_manifest_declares_runtime_api_inventory_scope_decision() -> None:
    ...
    assert str(decision.get("decision_id", "")).strip() == "RUNTIME-API-INVENTORY-SCOPE-V1"
...
def test_release_blocking_manifest_fixtures_validate_against_schemas() -> None:
...
def test_release_blocking_runtime_api_responses_match_versioned_contracts() -> None:
...
def test_release_blocking_runtime_bootstrap_config_matches_contract() -> None:
...
def test_release_blocking_persistence_manifest_is_aligned_with_migration_and_runner() -> None:
...
def test_release_blocking_runtime_operational_snapshot_matches_contract() -> None:
...
def test_release_blocking_sidecar_metrics_envelope_matches_contract() -> None:
...
def test_release_blocking_contract_surfaces_references_manifest_and_change_policy() -> None:
    ...
    assert "RUNTIME-API-INVENTORY-SCOPE-V1" in text
    assert "/runtime/signal-events" in text
    assert "/runtime/strategy-registry" in text


def test_release_blocking_disprover_payload_mutation_without_contract_update_fails() -> None:
