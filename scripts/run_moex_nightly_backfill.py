...
DEFAULT_CANONICALIZATION_ROOT = Path("artifacts/codex/moex-canonicalization")
...
def main() -> None:
    ...
    canonicalization_root = _resolve(Path(args.canonicalization_root))
    ...
    canonicalization_run_dir = canonicalization_root / run_id
    canonicalization_run_dir.mkdir(parents=True, exist_ok=True)
    ...
    jobs = _build_jobs(
        run_id=run_id,
        raw_ingest_run_dir=raw_ingest_run_dir,
    ...
    if args.stop_after_raw_ingest:
        report = {
            ...
            "artifacts": {
                "raw_ingest_root": raw_ingest_run_dir.as_posix(),
                "raw_ingest_report": raw_ingest_report_path.as_posix(),
                "raw_ingest_summary_report": raw_ingest_summary_report_path.as_posix(),
                "raw_table": consolidated_raw_path.as_posix(),
    ...
    canonical_report = run_moex_canonicalization(
    ...
    report = {
        ...
        "artifacts": {
            "raw_ingest_root": raw_ingest_run_dir.as_posix(),
            "canonicalization_root": canonicalization_run_dir.as_posix(),
            "nightly_root": nightly_run_dir.as_posix(),
        },
    }
    report_path = nightly_run_dir / "nightly-backfill-report.json"
