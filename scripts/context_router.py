...
CONTEXTS: tuple[ContextSpec, ...] = (
    ...
    ContextSpec(
        ...
        owned_paths=(
            ...
            "tests/product-plane/unit/test_phase2a_",
    ...
    ContextSpec(
        ...
        owned_paths=(
            ...
            "tests/product-plane/unit/test_phase2b_",
    ...
    ContextSpec(
        ...
        owned_paths=(
            ...
            "tests/product-plane/unit/test_phase2c_",
            "tests/product-plane/unit/test_phase2d_",
            "tests/product-plane/unit/test_phase3_",
            ...
            "tests/product-plane/unit/test_phase6_",
            "tests/product-plane/unit/test_phase7_",
        ),
