# Operational Hardening Operational Hardening Runbook
...
## Preconditions
- Operational Hardening unit/integration tests are green.
...
1. Run Operational Hardening integration tests:
   - `python -m pytest tests/product-plane/integration/test_operational_hardening.py -q`
2. Run Operational Hardening unit tests:
