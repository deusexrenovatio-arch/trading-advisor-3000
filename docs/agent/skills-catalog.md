...
<!-- catalog-sha256: 9fcc739df6b6acd7247d7e8a96830f923c7f13fcd2da5b4066ed1812c8cd110e -->
...
| `ta3000-quant-compute-methodology` | `KEEP_CORE` | `WAVE_1` | `ACTIVE` | TA3000 vectorbt, pandas-ta-classic, Optuna, and native-runtime methodology for research compute integration | `CTX-COMPUTE` | vectorbt; pandas-ta-classic; pandas_ta_classic; Optuna; optimizer search; native runtime ownership; signal matrix; from_signals; from_order_func; technical indicators; derived indicators; research backtest; strategy execution | `repo_local` | `cold-by-default` |
