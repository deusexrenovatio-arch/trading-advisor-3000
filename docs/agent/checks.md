...
| Test audit matrix drift | `python scripts/sync_test_audit_matrix.py --check` | validate package-owned audit state and test-tree/config fingerprints without optional runtime imports |
