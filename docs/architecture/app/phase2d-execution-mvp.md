...
## Deliverables
- `src/trading_advisor_3000/app/contracts/execution.py`
- `src/trading_advisor_3000/app/contracts/schemas/broker_order.v1.json`
...
- `src/trading_advisor_3000/app/execution/intents/paper_broker.py`
- `src/trading_advisor_3000/app/execution/adapters/stocksharp_sidecar_stub.py`
- `src/trading_advisor_3000/app/execution/reconciliation/reconcile.py`
- `tests/app/contracts/test_phase2d_execution_contracts.py`
- `tests/app/integration/test_phase2d_execution.py`
- `tests/app/unit/test_phase2d_reconciliation.py`
...
## Acceptance Commands
- `python -m pytest tests/app/contracts/test_phase2d_execution_contracts.py -q`
- `python -m pytest tests/app/integration/test_phase2d_execution.py -q`
- `python -m pytest tests/app/unit/test_phase2d_reconciliation.py -q`
