# Shell Delivery Operational Proving - CI, Pilot, And Operational Proving
...
6. Evidence remains durable through a single report artifact (`artifacts/shell-delivery-operational-proving.json`) plus dashboard pack outputs.

## Acceptance Commands
- `python -m pytest tests/process/test_shell_delivery_operational_proving.py -q`
