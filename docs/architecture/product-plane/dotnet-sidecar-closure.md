# .NET Sidecar - Real .NET Sidecar Closure (E1)
...
python scripts/smoke_stocksharp_sidecar_binary.py --sidecar-binary artifacts/dotnet-sidecar/stocksharp-sidecar/publish/TradingAdvisor3000.StockSharpSidecar.dll
```
