...
| Research strategy governance | `technical_indicator_snapshot.v1`, `strategy_candidate_projection.v1`, `strategy_scorecard.v1`, `strategy_promotion_decision.v1` | implemented | Canonical-to-strategy governed flow uses indicator snapshots, versioned projection, scorecard, and promotion decision contracts. |
