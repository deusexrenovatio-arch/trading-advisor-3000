# Controlled Live Execution - Live Execution Integration (Controlled)
...
- `tests/product-plane/unit/test_live_reconciliation.py`
- `tests/product-plane/integration/test_controlled_live_execution.py`
- `docs/runbooks/app/live-execution-incident-runbook.md`
...
## Acceptance Commands
- `python -m pytest tests/product-plane/unit/test_live_bridge.py -q`
- `python -m pytest tests/product-plane/unit/test_live_broker_sync.py -q`
- `python -m pytest tests/product-plane/unit/test_live_reconciliation.py -q`
...
- production scheduler rollout and infra topology hardening (Review and Observability+).
