...
- `tests/product-plane/integration/test_phase2b_dagster_bootstrap.py`
- `tests/product-plane/integration/test_research_jobs_cli.py`
...
3. use `test_phase2b_dagster_bootstrap.py` as the main Stage 7 orchestration proof
4. use `test_research_jobs_cli.py` for operational job proof
...
- `python -m pytest tests/product-plane/integration/test_research_jobs_cli.py -q`
