...
- In Scope: `docs/checklists/app/*` re-acceptance wording updates, `docs/architecture/app/phase10-stack-conformance-reacceptance-report.md`, `artifacts/acceptance/f1/*`, route-state alignment (`docs/session_handoff.md`, `docs/tasks/active/index.yaml`, this task note), and phase-matching checks.
