# Task Note
Updated: 2026-06-10 21:13 UTC

## Goal
- Deliver: Fix raw ingest tail refresh and indicator reuse performance
...
- Solution Intent: raw reconcile is table/action-driven; large scoped deletes are forbidden as literal OR predicates.
- Active contour: baseline report publishes explicit continuous-front catch-up windows; full continuous-front rebuild remains explicit via `cf_rebuild` or `data_layer_rebuild`.
