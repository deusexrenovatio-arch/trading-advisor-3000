...
class PandasTaPostTransformAdapter:
    adapter_id = "pandas_ta_with_post_transform_adapter"
    adapter_version = ADAPTER_VERSION
    supported_formula_ids: set[str] = {"sma", "ema", "hma", "donchian", "bbands", "kc", "vwma", "supertrend"}
    ...
    def compute_partition(
        ...
        qc = pd.DataFrame(
            [
                {
                    "check_id": "pandas_ta_post_transform_contract",
                    "status": "pass",
