    ...
    return {
        ...
        "research_strategy_templates": {
            ...
            "columns": {
                ...
                "required_indicator_columns": "array<string>",
        ...
        "research_strategy_instance_modules": {
            ...
            "columns": {
                ...
                "derived_indicator_refs": "array<string>",
                "created_at": "timestamp",
            },
        },
    }
...
def materialize_strategy_template_manifest(
    *,
    ...
    incoming_template_row = {
        ...
        "required_indicator_columns": list(template_manifest.required_indicator_columns),
...
def materialize_strategy_instance_manifest(
    *,
    ...
    instance_row = {
        ...
        "required_indicator_columns": list(instance_manifest.required_indicator_columns),
    ...
    instance_module_rows = [
        {
            ...
            "derived_indicator_refs": list(module.derived_indicator_refs),
            "created_at": created_at,
        }
