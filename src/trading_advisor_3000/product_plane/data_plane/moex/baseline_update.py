...
ECONOMICS_PUBLISHED_REUSE_MAX_SOURCE_AGE_DAYS = 3
ECONOMICS_REQUIRED_POSITIVE_FIELDS = (
    "min_step",
    "lot_volume",
    "fx_rate_to_rub",
    "mr1",
...
def _published_contract_economics_coverage(
    *,
    ...
    base_report: dict[str, object] = {
        ...
        "delta_version": None,
        "max_source_age_days": ECONOMICS_PUBLISHED_REUSE_MAX_SOURCE_AGE_DAYS,
    ...
    for contract_id in required_contract_ids:
        ...
        invalid_fields = [
            field_name
            for field_name in ECONOMICS_REQUIRED_POSITIVE_FIELDS
        ...
        try:
            ...
            if source_age < 0 or source_age > ECONOMICS_PUBLISHED_REUSE_MAX_SOURCE_AGE_DAYS:
    ...
    return {
        **base_report,
        ...
        "economics_session_dates": economics_session_dates,
        "effective_session_dates": effective_session_dates,
        "source_age_days_max": max(source_age_days) if source_age_days else None,
    }


def _reuse_published_economics_after_source_unavailable(
    *,
    canonical_economics_root: Path,
    evidence_dir: Path,
    run_id: str,
    ...
    *,
    ...
    if resolved_economics_mode == ECONOMICS_REFRESH_MODE_REFRESH:
        try:
            ...
            try:
                economics_report = _reuse_published_economics_after_source_unavailable(
                    canonical_economics_root=canonical_economics_root,
                    evidence_dir=run_dir / "economics-refresh",
                    run_id=run_id,
                    source_error=exc,
