...
_MODULE_EXPORTS = {
    ...
    "MoexRuntimeInstance": (".runtime_instances", "MoexRuntimeInstance"),
    "MoexRuntimeInstancesRegistry": (".runtime_instances", "MoexRuntimeInstancesRegistry"),
    "record_technical_route_blocked_conflict": (
        ".historical_route_contracts",
        "record_technical_route_blocked_conflict",
    ),
