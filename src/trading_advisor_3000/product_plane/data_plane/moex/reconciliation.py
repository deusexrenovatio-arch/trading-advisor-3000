...
def load_reconciliation_threshold_policy(path: Path) -> ThresholdPolicy:
...
def run_moex_reconciliation(
    *,
    ...
    policy = load_reconciliation_threshold_policy(threshold_policy_path)
